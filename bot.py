    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Updates Channel", url="https://t.me/+386Gb-Nzsi1hZWE1")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("Support Group", url="https://t.me/AnonyMous_Giveaway_Chat"),
                        InlineKeyboardButton("YouTube Channel", url="www.youtube.com/@Sky_CoderZ")
                    ]
                ]
            )
        )
